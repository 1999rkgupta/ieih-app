    ...
    <div className="fixed bottom-0 inset-x-0 z-40 select-none pointer-events-none pb-2 sm:pb-3 px-3 sm:px-4">
      <div className="max-w-md sm:max-w-xl mx-auto flex flex-col items-center">
        ...
        <nav 
          ...
          className="pointer-events-auto w-full relative rounded-[26px] sm:rounded-[28px] bg-[#d7ece6]/92 dark:bg-[#0d1614]/92 backdrop-blur-2xl saturate-150 border border-white/80 dark:border-[#91baaf]/30 shadow-[0_14px_36px_rgba(30,70,60,0.16),0_2px_6px_rgba(0,0,0,0.04)] dark:shadow-[0_18px_45px_rgba(0,0,0,0.8),inset_0_1px_0_rgba(145,186,175,0.2)] transition-all duration-300 p-1 sm:p-1.5"
        >
            ...
            {navItems.map(item => {
              ...
              if (item.isAction) {
                return (
                  ...
                  >
                    ...
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-b from-[#18483d] to-[#0f322a] dark:from-[#91baaf] dark:to-[#71a396] text-white dark:text-[#090e0c] flex items-center justify-center shadow-lg shadow-[#18483d]/25 dark:shadow-[#91baaf]/20 group-hover:scale-105 group-active:scale-90 transition-all duration-200 border border-white/20 dark:border-white/30">
                      <Plus className="w-5 h-5 sm:w-5.5 sm:h-5.5 stroke-[2.6px]" />
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-bold text-[#143e34] dark:text-[#afd2c6] mt-0.5 tracking-tight leading-none">
                      {item.label}
                    </span>
                  </button>
                );
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    <span className="absolute inset-0 rounded-2xl bg-[#91baaf]/40 dark:bg-[#91baaf]/20 border border-[#91baaf]/50 dark:border-[#91baaf]/35 -z-10 animate-fadeIn" />
                  )}
        ...
        <div className="w-28 sm:w-32 h-1 rounded-full bg-[#1e453c]/40 dark:bg-[#91baaf]/40 mt-1.5 pointer-events-none transition-opacity" />
      </div>
    </div>
  );
};
